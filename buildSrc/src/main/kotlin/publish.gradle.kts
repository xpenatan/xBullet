        ...
        publications.configureEach {
            if (this is MavenPublication) {
                pom {
                    ...
                    description.set("Bullet Physics Java Bindings")
                    url.set("https://github.com/xpenatan/xBullet")
                    developers {
                        developer {
                            id.set("Xpe")
                            name.set("Natan")
                    ...
                    scm {
                        connection.set("scm:git:git://https://github.com/xpenatan/xBullet.git")
                        developerConnection.set("scm:git:ssh://https://github.com/xpenatan/xBullet.git")
                        url.set("http://https://github.com/xpenatan/xBullet/tree/master")
                    }
                    licenses {
                        license {
