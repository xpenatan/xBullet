...
public class IDLArray extends IDLBase {
    ...
    /*
      [-TEAVM;-NATIVE]
            ...
            jsObj.resize(size);
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "size"}, script = "var jsObj = bullet.wrapPointer(this_addr, bullet.IDLArray); jsObj.resize(size);")
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = bullet.wrapPointer(this_addr, bullet.IDLArray);
      jsObj.clear();
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = bullet.wrapPointer(this_addr, bullet.IDLArray);jsObj.clear();")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = bullet.wrapPointer(this_addr, bullet.IDLArray);var returnedJSObj = jsObj.getSize();return returnedJSObj;")
    ...
    /*
      ...
      return returnedJSObj;
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = bullet.wrapPointer(this_addr, bullet.IDLArray);var returnedJSObj = jsObj.getVoidData();return returnedJSObj;")
